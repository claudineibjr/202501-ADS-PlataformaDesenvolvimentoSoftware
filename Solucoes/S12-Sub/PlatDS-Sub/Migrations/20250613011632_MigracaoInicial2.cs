        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Arrecadacao = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    NotaIMDB = table.Column<float>(type: "float", nullable: false),
                    Atores = table.Column<string>(type: "longtext", nullable: false, collation: "utf8mb4_0900_ai_ci")
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
